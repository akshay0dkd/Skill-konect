...
import { initializeFirestore, persistentLocalCache, CACHE_SIZE_UNLIMITED, enableIndexedDbPersistence } from 'firebase/firestore';
...
var initializeFirebase = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                if (error_1.code == 'failed-precondition') {
                    console.warn("Firebase persistence failed: Multiple tabs open?");
                }
                else if (error_1.code == 'unimplemented') {
